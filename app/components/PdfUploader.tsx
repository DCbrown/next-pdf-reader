      ...
      if (arrayBuffer && arrayBuffer instanceof ArrayBuffer) {
        ...
        loadingTask.promise.then(
          (pdfDoc) => {
            ...
            if (numPages > 4) {
              alert(
                "Please note that due to the limitations of our free service, only the first 4 pages will be considered for processing."
              );
            }
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center">
            <input
              ...
              hidden
            />
            <button onClick={handleButtonClick} className={styles.mainBtn}>
            ...
            <p className={styles.supportedFormat}>Supported format: PDF</p>
