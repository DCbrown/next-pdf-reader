...
function Header() {
  return (
    ...
    >
      <div className="block md:flex items-end gap-3"></div>
      <div className="flex space-x-4 justify-center items-center">
        ...
        <SignedOut>
          <SignInButton mode="modal">
            <button className="text-blue-300 border border-blue-500 hover:text-white hover:bg-[#2d06ff4a] py-2 px-4 rounded-3xl transition duration-300 ease-in-out">
              Sign in
            </button>
          </SignInButton>
